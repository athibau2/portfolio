...
const savaDescription =
    "In March 2022, I was hired by Sava, a Utah startup, to help develop their mobile app. I developed in Flutter/Dart and collaborated with one other software developer to improve their beta product and add necessary features and functionality.\n\nI implemented coding best practices and suggested ways to improve the existing code. I was also responsible for configuring the beta app for launch on the Google Play Store.";
...
const byuDescription =
    "Brigham Young University has a fantastic Information Technology program. It is ranked #4 among the 2023 Best Information Technology Bachelor's Degree Schools. It is also paired with BYU's Cybersecurity program, so I am receiving in-depth training in both IT and Cybersecurity disciplines.\n\nI am focusing my education on software development so that my full-stack skills are optimal and high-level, making me a major benefit to companies and clients!";
