...
const schedulingDescription = "Beginning May 2022, I am being hired freelance by a fellow student to develop a full-stack, subscription-based salon scheduling software. I will be designing and implementing a complex database that will be connected to a responsive web application via REST APIs.";
...
const webDevDescription = "This semester, I am learning advanced web development and building a full-stack web application. This class teaches asynchronous and functional programming, deployment and database connections, and advanced concepts in web frameworks.\n\nMy application is marketed towards those who struggle to write in a journal for various reasons. It gives users a new prompt to respond to each day so that journaling doesn't need to take a long time and can be simple with unique entries.";

const databaseDescription = "In my databases class this semester, I am learning how to build and implement complex relational databases, as well as NoSQL databases. I am working with a small group to develop a relational database and implement it into a full-stack web application.\n\nOur project is to create an online note-taking system that beats all others. It is designed for effectiveness and will help users to organize their notes in a way that will promote better learning and efficiency.";
