...
class Skill {
  static List<Skill> getSkills() => [
    ...
    Skill("assets/icons/sql.png", "SQL", "https://en.wikipedia.org/wiki/SQL", "Knowing SQL is a must for any developer. Web and mobile apps would be nearly useless without utilizing SQL to manage data. I have been using SQL for a few years now, and I am very comfortable writing queries and working with many databases to get the data I need."),
